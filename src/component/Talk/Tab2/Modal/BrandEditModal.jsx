...
const Main = ({ modalVisible2, setModalVisible2, setModal }) => {
    ...
    const selectSubmit = async (e) => {
        ...
        setModalVisible2({ ...modalVisible2, open: false, flag: 'edit' });
    }
                    ...
                    <View style={styles.modalContainer2}>
                        <View style={styles.header}>
                            <TouchableOpacity style={styles.closeBox}
                                onPress={() => setModalVisible2((prevState) => ({ ...prevState, open: false }))}>
