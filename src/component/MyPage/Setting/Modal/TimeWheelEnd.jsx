                    ...
                    <View style={styles.modalContainer2}>
                        <View style={styles.wheelContainer}>
                            ...
                            <WheelPickerExpo
                                ...
                                onChange={({ item }) => {setModal(prevState => ({...prevState, hours: item.label})), AsyncStorage.setItem('alarmEndHours', item.label)}}
                                renderItem={(props) => (
                                    <Text
                                        style={[
                                            styles.text,
                            ...
                            <WheelPickerExpo
                                ...
                                onChange={({ item }) =>  {setModal(prevState => ({...prevState, minutes: item.label})), AsyncStorage.setItem('alarmEndMinutes', item.label)}}
                                renderItem={(props) => (
                                    <Text
                                        style={[
                                            styles.text,
