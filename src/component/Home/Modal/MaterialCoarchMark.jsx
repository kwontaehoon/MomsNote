...
const Main = ({ modal, setModal, recommendListModal, setRecommendListModal }) => {
    ...
    const close = async () => {
        ...
        isChecked ? recommendList ? (AsyncStorage.setItem('materialCoarchMark', '1'), setModal(false)) : (setModal(false), setRecommendListModal(true)) : setModal(false);
    }
        ...
        <Modal animationType="fade" transparent={true} visible={modal} statusBarTranslucent={true}
            ...
            <View style={styles.modalContainer}>
                <View style={styles.modalView}>
                    <View style={[styles.modalContainer2, { position: 'absolute', backgroundColor: 'white', opacity: 0.4 }]}>
                        <View style={[styles.modalBox, { justifyContent: 'flex-start', flex: 1, height: '100%'}]}>
                        ...
                        <View style={[styles.modalBox, {flex: 1, height: '100%'}]}>
