...
const styles = StyleSheet.create({
    ...
    selectedStyle1: { borderColor: '#202124', borderWidth: 1 },
    selectedStyle2: { borderColor: '#202124', borderWidth: 1 },
})
                    ...
                    <View style={styles.modalContainer2}>
                        <View style={styles.wheelContainer}>
                            <WheelPickerExpo
                                ...
                                onChange={({ item }) => { setModal(prevState => ({...prevState, clock: item.label})); AsyncStorage.setItem('alarmStartClock', item.label)}}
                                renderItem={(props) => (
                                    <Text
                                        style={[
                                            styles.text,
